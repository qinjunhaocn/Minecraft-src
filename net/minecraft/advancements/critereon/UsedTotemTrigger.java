...
extends SimpleCriterionTrigger<TriggerInstance> {
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player, Optional<ItemPredicate> item) implements SimpleCriterionTrigger.SimpleInstance
    {
        ...
        public static Criterion<TriggerInstance> usedTotem(ItemPredicate $$0) {
            return CriteriaTriggers.USED_TOTEM.createCriterion(new TriggerInstance(Optional.empty(), Optional.of($$0)));
        }

        public static Criterion<TriggerInstance> usedTotem(HolderGetter<Item> $$0, ItemLike $$1) {
            return CriteriaTriggers.USED_TOTEM.createCriterion(new TriggerInstance(Optional.empty(), Optional.of(ItemPredicate.Builder.item().a($$0, $$1).build())));
        }
