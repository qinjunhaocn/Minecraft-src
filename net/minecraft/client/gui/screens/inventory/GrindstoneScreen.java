...
extends AbstractContainerScreen<GrindstoneMenu> {
    ...
    protected void renderBg(GuiGraphics $$0, float $$1, int $$2, int $$3) {
        ...
        $$0.blit(RenderPipelines.GUI_TEXTURED, GRINDSTONE_LOCATION, $$4, $$5, 0.0f, 0.0f, this.imageWidth, this.imageHeight, 256, 256);
        if ((((GrindstoneMenu)this.menu).getSlot(0).hasItem() || ((GrindstoneMenu)this.menu).getSlot(1).hasItem()) && !((GrindstoneMenu)this.menu).getSlot(2).hasItem()) {
            $$0.blitSprite(RenderPipelines.GUI_TEXTURED, ERROR_SPRITE, $$4 + 92, $$5 + 31, 28, 21);
        }
    }
}
