...
extends Screen {
    ...
    protected void init() {
        ...
        this.disconnectButton = this.layout.addChild(Button.builder(CommonComponents.GUI_DISCONNECT, $$0 -> this.connection.disconnect(ConnectScreen.ABORT_CONNECTION)).build());
