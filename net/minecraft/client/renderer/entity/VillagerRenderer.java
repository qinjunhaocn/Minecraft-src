...
extends AgeableMobRenderer<Villager, VillagerRenderState, VillagerModel> {
    ...
    public VillagerRenderer(EntityRendererProvider.Context $$0) {
        super($$0, new VillagerModel($$0.bakeLayer(ModelLayers.VILLAGER)), new VillagerModel($$0.bakeLayer(ModelLayers.VILLAGER_BABY)), 0.5f);
        this.addLayer(new CustomHeadLayer<VillagerRenderState, VillagerModel>(this, $$0.getModelSet(), CUSTOM_HEAD_TRANSFORMS));
        this.addLayer(new VillagerProfessionLayer<VillagerRenderState, VillagerModel>(this, $$0.getResourceManager(), "villager"));
    ...
    @Override
    protected float getShadowRadius(VillagerRenderState $$0) {
    ...
    @Override
    public void extractRenderState(Villager $$0, VillagerRenderState $$1, float $$2) {
