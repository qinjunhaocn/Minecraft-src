...
{
    public static final MapCodec<Damage> MAP_CODEC = RecordCodecBuilder.mapCodec($$0 -> $$0.group((App)Codec.BOOL.optionalFieldOf("normalize", (Object)true).forGetter(Damage::normalize)).apply((Applicative)$$0, Damage::new));
