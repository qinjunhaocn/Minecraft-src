...
implements NoDataSpecialModelRenderer {
    ...
    public HangingSignSpecialRenderer(Model $$0, Material $$1) {
        this.model = $$0;
        this.material = $$1;
    }
    ...
    public void render(ItemDisplayContext $$0, PoseStack $$1, MultiBufferSource $$2, int $$3, int $$4, boolean $$5) {
        HangingSignRenderer.renderInHand($$1, $$2, $$3, $$4, this.model, this.material);
    }

    @Override
    public void getExtents(Set<Vector3f> $$0) {
        PoseStack $$1 = new PoseStack();
        HangingSignRenderer.translateBase($$1, 0.0f);
    ...
    public record Unbaked(WoodType woodType, Optional<ResourceLocation> texture) implements SpecialModelRenderer.Unbaked
    {
        ...
        public SpecialModelRenderer<?> bake(EntityModelSet $$0) {
            Model $$1 = HangingSignRenderer.createSignModel($$0, this.woodType, HangingSignRenderer.AttachmentType.CEILING_MIDDLE);
            Material $$2 = this.texture.map(Sheets.HANGING_SIGN_MAPPER::apply).orElseGet(() -> Sheets.getHangingSignMaterial(this.woodType));
            return new HangingSignSpecialRenderer($$1, $$2);
        }
    }
}
