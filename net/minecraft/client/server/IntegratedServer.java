...
extends MinecraftServer {
    ...
    public IntegratedServer(Thread $$0, Minecraft $$1, LevelStorageSource.LevelStorageAccess $$2, PackRepository $$3, WorldStem $$4, Services $$5, ChunkProgressListenerFactory $$6) {
        ...
        this.setSingleplayerProfile($$1.getGameProfile());
    ...
    public void tickServer(BooleanSupplier $$0) {
        ...
        if (($$5 = Math.max(2, this.minecraft.options.simulationDistance().get())) != this.previousSimulationDistance) {
    ...
    public SystemReport fillServerSystemReport(SystemReport $$0) {
        ...
        $$0.setDetail("Launched Version", this.minecraft::getLaunchedVersion);
        return $$0;
    }
    ...
    public boolean publishServer(@Nullable GameType $$0, boolean $$1, int $$2) {
        try {
            ...
            this.getPlayerList().setAllowCommandsForAllPlayers($$1);
    ...
    public void halt(boolean $$0) {
        this.executeBlocking(() -> {
            ArrayList<ServerPlayer> $$0 = Lists.newArrayList(this.getPlayerList().getPlayers());
            for (ServerPlayer $$1 : $$0) {
                if ($$1.getUUID().equals(this.uuid)) continue;
    ...
    public void reportChunkLoadFailure(Throwable $$0, RegionStorageInfo $$1, ChunkPos $$2) {
        ...
        this.warnOnLowDiskSpace();
        this.minecraft.execute(() -> SystemToast.onChunkLoadFailure(this.minecraft, $$2));
    }
    ...
    public void reportChunkSaveFailure(Throwable $$0, RegionStorageInfo $$1, ChunkPos $$2) {
        ...
        this.warnOnLowDiskSpace();
        this.minecraft.execute(() -> SystemToast.onChunkSaveFailure(this.minecraft, $$2));
    }
