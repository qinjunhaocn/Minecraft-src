...
extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        List $$02 = List.of((Object[])new Item[]{Items.BLACK_DYE, Items.BLUE_DYE, Items.BROWN_DYE, Items.CYAN_DYE, Items.GRAY_DYE, Items.GREEN_DYE, Items.LIGHT_BLUE_DYE, Items.LIGHT_GRAY_DYE, Items.LIME_DYE, Items.MAGENTA_DYE, Items.ORANGE_DYE, Items.PINK_DYE, Items.PURPLE_DYE, Items.RED_DYE, Items.YELLOW_DYE, Items.WHITE_DYE});
        List $$1 = List.of((Object[])new Item[]{Items.BLACK_WOOL, Items.BLUE_WOOL, Items.BROWN_WOOL, Items.CYAN_WOOL, Items.GRAY_WOOL, Items.GREEN_WOOL, Items.LIGHT_BLUE_WOOL, Items.LIGHT_GRAY_WOOL, Items.LIME_WOOL, Items.MAGENTA_WOOL, Items.ORANGE_WOOL, Items.PINK_WOOL, Items.PURPLE_WOOL, Items.RED_WOOL, Items.YELLOW_WOOL, Items.WHITE_WOOL});
        List $$2 = List.of((Object[])new Item[]{Items.BLACK_BED, Items.BLUE_BED, Items.BROWN_BED, Items.CYAN_BED, Items.GRAY_BED, Items.GREEN_BED, Items.LIGHT_BLUE_BED, Items.LIGHT_GRAY_BED, Items.LIME_BED, Items.MAGENTA_BED, Items.ORANGE_BED, Items.PINK_BED, Items.PURPLE_BED, Items.RED_BED, Items.YELLOW_BED, Items.WHITE_BED});
        List $$3 = List.of((Object[])new Item[]{Items.BLACK_CARPET, Items.BLUE_CARPET, Items.BROWN_CARPET, Items.CYAN_CARPET, Items.GRAY_CARPET, Items.GREEN_CARPET, Items.LIGHT_BLUE_CARPET, Items.LIGHT_GRAY_CARPET, Items.LIME_CARPET, Items.MAGENTA_CARPET, Items.ORANGE_CARPET, Items.PINK_CARPET, Items.PURPLE_CARPET, Items.RED_CARPET, Items.YELLOW_CARPET, Items.WHITE_CARPET});
        List $$4 = List.of((Object[])new Item[]{Items.BLACK_HARNESS, Items.BLUE_HARNESS, Items.BROWN_HARNESS, Items.CYAN_HARNESS, Items.GRAY_HARNESS, Items.GREEN_HARNESS, Items.LIGHT_BLUE_HARNESS, Items.LIGHT_GRAY_HARNESS, Items.LIME_HARNESS, Items.MAGENTA_HARNESS, Items.ORANGE_HARNESS, Items.PINK_HARNESS, Items.PURPLE_HARNESS, Items.RED_HARNESS, Items.YELLOW_HARNESS, Items.WHITE_HARNESS});
        this.colorItemWithDye($$02, $$1, "wool", RecipeCategory.BUILDING_BLOCKS);
        this.colorItemWithDye($$02, $$2, "bed_dye", RecipeCategory.DECORATIONS);
        this.colorItemWithDye($$02, $$3, "carpet_dye", RecipeCategory.DECORATIONS);
        this.colorItemWithDye($$02, $$4, "harness_dye", RecipeCategory.COMBAT);
        ...
        this.chiseledBuilder(RecipeCategory.BUILDING_BLOCKS, Blocks.CHISELED_STONE_BRICKS, Ingredient.of(Blocks.STONE_BRICK_SLAB)).unlockedBy("has_tag", (Criterion)this.has(ItemTags.STONE_BRICKS)).save(this.output);
        ...
        this.shapeless(RecipeCategory.MISC, Items.FIRE_CHARGE, 3).requires(Items.GUNPOWDER).requires(Items.BLAZE_POWDER).requires(Ingredient.a(Items.COAL, Items.CHARCOAL)).unlockedBy("has_blaze_powder", (Criterion)this.has(Items.BLAZE_POWDER)).save(this.output);
        ...
        this.doorBuilder(Blocks.IRON_DOOR, Ingredient.of(Items.IRON_INGOT)).unlockedBy(VanillaRecipeProvider.getHasName(Items.IRON_INGOT), this.has(Items.IRON_INGOT)).save(this.output);
        ...
        BuiltInRegistries.ITEM.stream().forEach($$0 -> {
            SuspiciousEffectHolder $$1 = SuspiciousEffectHolder.tryGet($$0);
            if ($$1 != null) {
                this.suspiciousStew((Item)$$0, $$1);
            }
        });
        ...
        this.slabBuilder(RecipeCategory.BUILDING_BLOCKS, Blocks.PURPUR_SLAB, Ingredient.a(Blocks.PURPUR_BLOCK, Blocks.PURPUR_PILLAR)).unlockedBy("has_purpur_block", this.has(Blocks.PURPUR_BLOCK)).save(this.output);
        this.stairBuilder(Blocks.PURPUR_STAIRS, Ingredient.a(Blocks.PURPUR_BLOCK, Blocks.PURPUR_PILLAR)).unlockedBy("has_purpur_block", this.has(Blocks.PURPUR_BLOCK)).save(this.output);
        ...
        this.slabBuilder(RecipeCategory.BUILDING_BLOCKS, Blocks.QUARTZ_SLAB, Ingredient.a(Blocks.CHISELED_QUARTZ_BLOCK, Blocks.QUARTZ_BLOCK, Blocks.QUARTZ_PILLAR)).unlockedBy("has_chiseled_quartz_block", this.has(Blocks.CHISELED_QUARTZ_BLOCK)).unlockedBy("has_quartz_block", this.has(Blocks.QUARTZ_BLOCK)).unlockedBy("has_quartz_pillar", this.has(Blocks.QUARTZ_PILLAR)).save(this.output);
        this.stairBuilder(Blocks.QUARTZ_STAIRS, Ingredient.a(Blocks.CHISELED_QUARTZ_BLOCK, Blocks.QUARTZ_BLOCK, Blocks.QUARTZ_PILLAR)).unlockedBy("has_chiseled_quartz_block", this.has(Blocks.CHISELED_QUARTZ_BLOCK)).unlockedBy("has_quartz_block", this.has(Blocks.QUARTZ_BLOCK)).unlockedBy("has_quartz_pillar", this.has(Blocks.QUARTZ_PILLAR)).save(this.output);
        ...
        this.slabBuilder(RecipeCategory.BUILDING_BLOCKS, Blocks.RED_SANDSTONE_SLAB, Ingredient.a(Blocks.RED_SANDSTONE, Blocks.CHISELED_RED_SANDSTONE)).unlockedBy("has_red_sandstone", this.has(Blocks.RED_SANDSTONE)).unlockedBy("has_chiseled_red_sandstone", this.has(Blocks.CHISELED_RED_SANDSTONE)).save(this.output);
        ...
        this.slabBuilder(RecipeCategory.BUILDING_BLOCKS, Blocks.SANDSTONE_SLAB, Ingredient.a(Blocks.SANDSTONE, Blocks.CHISELED_SANDSTONE)).unlockedBy("has_sandstone", this.has(Blocks.SANDSTONE)).unlockedBy("has_chiseled_sandstone", this.has(Blocks.CHISELED_SANDSTONE)).save(this.output);
        this.stairBuilder(Blocks.SANDSTONE_STAIRS, Ingredient.a(Blocks.SANDSTONE, Blocks.CHISELED_SANDSTONE, Blocks.CUT_SANDSTONE)).unlockedBy("has_sandstone", this.has(Blocks.SANDSTONE)).unlockedBy("has_chiseled_sandstone", this.has(Blocks.CHISELED_SANDSTONE)).unlockedBy("has_cut_sandstone", this.has(Blocks.CUT_SANDSTONE)).save(this.output);
        ...
        this.slabBuilder(RecipeCategory.BUILDING_BLOCKS, Blocks.STONE_BRICK_SLAB, Ingredient.of(Blocks.STONE_BRICKS)).unlockedBy("has_stone_bricks", this.has(ItemTags.STONE_BRICKS)).save(this.output);
        this.stairBuilder(Blocks.STONE_BRICK_STAIRS, Ingredient.of(Blocks.STONE_BRICKS)).unlockedBy("has_stone_bricks", this.has(ItemTags.STONE_BRICKS)).save(this.output);
        ...
        this.shaped(RecipeCategory.REDSTONE, Blocks.TNT).define(Character.valueOf('#'), Ingredient.a(Blocks.SAND, Blocks.RED_SAND)).define(Character.valueOf('X'), Items.GUNPOWDER).pattern("X#X").pattern("#X#").pattern("X#X").unlockedBy("has_gunpowder", (Criterion)this.has(Items.GUNPOWDER)).save(this.output);
        ...
        this.shaped(RecipeCategory.DECORATIONS, Blocks.TORCH, 4).define(Character.valueOf('#'), Items.STICK).define(Character.valueOf('X'), Ingredient.a(Items.COAL, Items.CHARCOAL)).pattern("X").pattern("#").unlockedBy("has_stone_pickaxe", (Criterion)this.has(Items.STONE_PICKAXE)).save(this.output);
        this.shaped(RecipeCategory.DECORATIONS, Blocks.SOUL_TORCH, 4).define(Character.valueOf('X'), Ingredient.a(Items.COAL, Items.CHARCOAL)).define(Character.valueOf('#'), Items.STICK).define(Character.valueOf('S'), ItemTags.SOUL_FIRE_BASE_BLOCKS).pattern("X").pattern("#").pattern("S").unlockedBy("has_soul_sand", (Criterion)this.has(ItemTags.SOUL_FIRE_BASE_BLOCKS)).save(this.output);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.POTATO), RecipeCategory.FOOD, Items.BAKED_POTATO, 0.35f, 200).unlockedBy("has_potato", (Criterion)this.has(Items.POTATO)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.CLAY_BALL), RecipeCategory.MISC, Items.BRICK, 0.3f, 200).unlockedBy("has_clay_ball", (Criterion)this.has(Items.CLAY_BALL)).save(this.output);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.CHORUS_FRUIT), RecipeCategory.MISC, Items.POPPED_CHORUS_FRUIT, 0.1f, 200).unlockedBy("has_chorus_fruit", (Criterion)this.has(Items.CHORUS_FRUIT)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.BEEF), RecipeCategory.FOOD, Items.COOKED_BEEF, 0.35f, 200).unlockedBy("has_beef", (Criterion)this.has(Items.BEEF)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.CHICKEN), RecipeCategory.FOOD, Items.COOKED_CHICKEN, 0.35f, 200).unlockedBy("has_chicken", (Criterion)this.has(Items.CHICKEN)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.COD), RecipeCategory.FOOD, Items.COOKED_COD, 0.35f, 200).unlockedBy("has_cod", (Criterion)this.has(Items.COD)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.KELP), RecipeCategory.FOOD, Items.DRIED_KELP, 0.1f, 200).unlockedBy("has_kelp", (Criterion)this.has(Blocks.KELP)).save(this.output, VanillaRecipeProvider.getSmeltingRecipeName(Items.DRIED_KELP));
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.SALMON), RecipeCategory.FOOD, Items.COOKED_SALMON, 0.35f, 200).unlockedBy("has_salmon", (Criterion)this.has(Items.SALMON)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.MUTTON), RecipeCategory.FOOD, Items.COOKED_MUTTON, 0.35f, 200).unlockedBy("has_mutton", (Criterion)this.has(Items.MUTTON)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.PORKCHOP), RecipeCategory.FOOD, Items.COOKED_PORKCHOP, 0.35f, 200).unlockedBy("has_porkchop", (Criterion)this.has(Items.PORKCHOP)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.RABBIT), RecipeCategory.FOOD, Items.COOKED_RABBIT, 0.35f, 200).unlockedBy("has_rabbit", (Criterion)this.has(Items.RABBIT)).save(this.output);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.SEA_PICKLE), RecipeCategory.MISC, Items.LIME_DYE, 0.1f, 200).unlockedBy("has_sea_pickle", (Criterion)this.has(Blocks.SEA_PICKLE)).save(this.output, VanillaRecipeProvider.getSmeltingRecipeName(Items.LIME_DYE));
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.CACTUS.asItem()), RecipeCategory.MISC, Items.GREEN_DYE, 1.0f, 200).unlockedBy("has_cactus", (Criterion)this.has(Blocks.CACTUS)).save(this.output);
        ((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)SimpleCookingRecipeBuilder.smelting(Ingredient.a(Items.GOLDEN_PICKAXE, Items.GOLDEN_SHOVEL, Items.GOLDEN_AXE, Items.GOLDEN_HOE, Items.GOLDEN_SWORD, Items.GOLDEN_HELMET, Items.GOLDEN_CHESTPLATE, Items.GOLDEN_LEGGINGS, Items.GOLDEN_BOOTS, Items.GOLDEN_HORSE_ARMOR), RecipeCategory.MISC, Items.GOLD_NUGGET, 0.1f, 200).unlockedBy("has_golden_pickaxe", (Criterion)this.has(Items.GOLDEN_PICKAXE))).unlockedBy("has_golden_shovel", (Criterion)this.has(Items.GOLDEN_SHOVEL))).unlockedBy("has_golden_axe", (Criterion)this.has(Items.GOLDEN_AXE))).unlockedBy("has_golden_hoe", (Criterion)this.has(Items.GOLDEN_HOE))).unlockedBy("has_golden_sword", (Criterion)this.has(Items.GOLDEN_SWORD))).unlockedBy("has_golden_helmet", (Criterion)this.has(Items.GOLDEN_HELMET))).unlockedBy("has_golden_chestplate", (Criterion)this.has(Items.GOLDEN_CHESTPLATE))).unlockedBy("has_golden_leggings", (Criterion)this.has(Items.GOLDEN_LEGGINGS))).unlockedBy("has_golden_boots", (Criterion)this.has(Items.GOLDEN_BOOTS))).unlockedBy("has_golden_horse_armor", (Criterion)this.has(Items.GOLDEN_HORSE_ARMOR)).save(this.output, VanillaRecipeProvider.getSmeltingRecipeName(Items.GOLD_NUGGET));
        ((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)SimpleCookingRecipeBuilder.smelting(Ingredient.a(Items.IRON_PICKAXE, Items.IRON_SHOVEL, Items.IRON_AXE, Items.IRON_HOE, Items.IRON_SWORD, Items.IRON_HELMET, Items.IRON_CHESTPLATE, Items.IRON_LEGGINGS, Items.IRON_BOOTS, Items.IRON_HORSE_ARMOR, Items.CHAINMAIL_HELMET, Items.CHAINMAIL_CHESTPLATE, Items.CHAINMAIL_LEGGINGS, Items.CHAINMAIL_BOOTS), RecipeCategory.MISC, Items.IRON_NUGGET, 0.1f, 200).unlockedBy("has_iron_pickaxe", (Criterion)this.has(Items.IRON_PICKAXE))).unlockedBy("has_iron_shovel", (Criterion)this.has(Items.IRON_SHOVEL))).unlockedBy("has_iron_axe", (Criterion)this.has(Items.IRON_AXE))).unlockedBy("has_iron_hoe", (Criterion)this.has(Items.IRON_HOE))).unlockedBy("has_iron_sword", (Criterion)this.has(Items.IRON_SWORD))).unlockedBy("has_iron_helmet", (Criterion)this.has(Items.IRON_HELMET))).unlockedBy("has_iron_chestplate", (Criterion)this.has(Items.IRON_CHESTPLATE))).unlockedBy("has_iron_leggings", (Criterion)this.has(Items.IRON_LEGGINGS))).unlockedBy("has_iron_boots", (Criterion)this.has(Items.IRON_BOOTS))).unlockedBy("has_iron_horse_armor", (Criterion)this.has(Items.IRON_HORSE_ARMOR))).unlockedBy("has_chainmail_helmet", (Criterion)this.has(Items.CHAINMAIL_HELMET))).unlockedBy("has_chainmail_chestplate", (Criterion)this.has(Items.CHAINMAIL_CHESTPLATE))).unlockedBy("has_chainmail_leggings", (Criterion)this.has(Items.CHAINMAIL_LEGGINGS))).unlockedBy("has_chainmail_boots", (Criterion)this.has(Items.CHAINMAIL_BOOTS)).save(this.output, VanillaRecipeProvider.getSmeltingRecipeName(Items.IRON_NUGGET));
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.CLAY), RecipeCategory.BUILDING_BLOCKS, Blocks.TERRACOTTA.asItem(), 0.35f, 200).unlockedBy("has_clay_block", (Criterion)this.has(Blocks.CLAY)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.NETHERRACK), RecipeCategory.MISC, Items.NETHER_BRICK, 0.1f, 200).unlockedBy("has_netherrack", (Criterion)this.has(Blocks.NETHERRACK)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.RESIN_CLUMP), RecipeCategory.MISC, Items.RESIN_BRICK, 0.1f, 200).unlockedBy("has_resin_clump", (Criterion)this.has(Blocks.RESIN_CLUMP)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.NETHER_QUARTZ_ORE), RecipeCategory.MISC, Items.QUARTZ, 0.2f, 200).unlockedBy("has_nether_quartz_ore", (Criterion)this.has(Blocks.NETHER_QUARTZ_ORE)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.WET_SPONGE), RecipeCategory.BUILDING_BLOCKS, Blocks.SPONGE.asItem(), 0.15f, 200).unlockedBy("has_wet_sponge", (Criterion)this.has(Blocks.WET_SPONGE)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.COBBLESTONE), RecipeCategory.BUILDING_BLOCKS, Blocks.STONE.asItem(), 0.1f, 200).unlockedBy("has_cobblestone", (Criterion)this.has(Blocks.COBBLESTONE)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.STONE), RecipeCategory.BUILDING_BLOCKS, Blocks.SMOOTH_STONE.asItem(), 0.1f, 200).unlockedBy("has_stone", (Criterion)this.has(Blocks.STONE)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.SANDSTONE), RecipeCategory.BUILDING_BLOCKS, Blocks.SMOOTH_SANDSTONE.asItem(), 0.1f, 200).unlockedBy("has_sandstone", (Criterion)this.has(Blocks.SANDSTONE)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.RED_SANDSTONE), RecipeCategory.BUILDING_BLOCKS, Blocks.SMOOTH_RED_SANDSTONE.asItem(), 0.1f, 200).unlockedBy("has_red_sandstone", (Criterion)this.has(Blocks.RED_SANDSTONE)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.QUARTZ_BLOCK), RecipeCategory.BUILDING_BLOCKS, Blocks.SMOOTH_QUARTZ.asItem(), 0.1f, 200).unlockedBy("has_quartz_block", (Criterion)this.has(Blocks.QUARTZ_BLOCK)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.STONE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.CRACKED_STONE_BRICKS.asItem(), 0.1f, 200).unlockedBy("has_stone_bricks", (Criterion)this.has(Blocks.STONE_BRICKS)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.BLACK_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.BLACK_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_black_terracotta", (Criterion)this.has(Blocks.BLACK_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.BLUE_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.BLUE_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_blue_terracotta", (Criterion)this.has(Blocks.BLUE_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.BROWN_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.BROWN_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_brown_terracotta", (Criterion)this.has(Blocks.BROWN_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.CYAN_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.CYAN_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_cyan_terracotta", (Criterion)this.has(Blocks.CYAN_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.GRAY_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.GRAY_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_gray_terracotta", (Criterion)this.has(Blocks.GRAY_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.GREEN_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.GREEN_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_green_terracotta", (Criterion)this.has(Blocks.GREEN_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.LIGHT_BLUE_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_light_blue_terracotta", (Criterion)this.has(Blocks.LIGHT_BLUE_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.LIGHT_GRAY_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.LIGHT_GRAY_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_light_gray_terracotta", (Criterion)this.has(Blocks.LIGHT_GRAY_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.LIME_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.LIME_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_lime_terracotta", (Criterion)this.has(Blocks.LIME_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.MAGENTA_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.MAGENTA_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_magenta_terracotta", (Criterion)this.has(Blocks.MAGENTA_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.ORANGE_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.ORANGE_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_orange_terracotta", (Criterion)this.has(Blocks.ORANGE_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.PINK_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.PINK_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_pink_terracotta", (Criterion)this.has(Blocks.PINK_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.PURPLE_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.PURPLE_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_purple_terracotta", (Criterion)this.has(Blocks.PURPLE_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.RED_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.RED_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_red_terracotta", (Criterion)this.has(Blocks.RED_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.WHITE_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.WHITE_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_white_terracotta", (Criterion)this.has(Blocks.WHITE_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.YELLOW_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.YELLOW_GLAZED_TERRACOTTA.asItem(), 0.1f, 200).unlockedBy("has_yellow_terracotta", (Criterion)this.has(Blocks.YELLOW_TERRACOTTA)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.ANCIENT_DEBRIS), RecipeCategory.MISC, Items.NETHERITE_SCRAP, 2.0f, 200).unlockedBy("has_ancient_debris", (Criterion)this.has(Blocks.ANCIENT_DEBRIS)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.BASALT), RecipeCategory.BUILDING_BLOCKS, Blocks.SMOOTH_BASALT, 0.1f, 200).unlockedBy("has_basalt", (Criterion)this.has(Blocks.BASALT)).save(this.output);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.COBBLED_DEEPSLATE), RecipeCategory.BUILDING_BLOCKS, Blocks.DEEPSLATE, 0.1f, 200).unlockedBy("has_cobbled_deepslate", (Criterion)this.has(Blocks.COBBLED_DEEPSLATE)).save(this.output);
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(Blocks.NETHER_QUARTZ_ORE), RecipeCategory.MISC, Items.QUARTZ, 0.2f, 100).unlockedBy("has_nether_quartz_ore", (Criterion)this.has(Blocks.NETHER_QUARTZ_ORE)).save(this.output, VanillaRecipeProvider.getBlastingRecipeName(Items.QUARTZ));
        ((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)SimpleCookingRecipeBuilder.blasting(Ingredient.a(Items.GOLDEN_PICKAXE, Items.GOLDEN_SHOVEL, Items.GOLDEN_AXE, Items.GOLDEN_HOE, Items.GOLDEN_SWORD, Items.GOLDEN_HELMET, Items.GOLDEN_CHESTPLATE, Items.GOLDEN_LEGGINGS, Items.GOLDEN_BOOTS, Items.GOLDEN_HORSE_ARMOR), RecipeCategory.MISC, Items.GOLD_NUGGET, 0.1f, 100).unlockedBy("has_golden_pickaxe", (Criterion)this.has(Items.GOLDEN_PICKAXE))).unlockedBy("has_golden_shovel", (Criterion)this.has(Items.GOLDEN_SHOVEL))).unlockedBy("has_golden_axe", (Criterion)this.has(Items.GOLDEN_AXE))).unlockedBy("has_golden_hoe", (Criterion)this.has(Items.GOLDEN_HOE))).unlockedBy("has_golden_sword", (Criterion)this.has(Items.GOLDEN_SWORD))).unlockedBy("has_golden_helmet", (Criterion)this.has(Items.GOLDEN_HELMET))).unlockedBy("has_golden_chestplate", (Criterion)this.has(Items.GOLDEN_CHESTPLATE))).unlockedBy("has_golden_leggings", (Criterion)this.has(Items.GOLDEN_LEGGINGS))).unlockedBy("has_golden_boots", (Criterion)this.has(Items.GOLDEN_BOOTS))).unlockedBy("has_golden_horse_armor", (Criterion)this.has(Items.GOLDEN_HORSE_ARMOR)).save(this.output, VanillaRecipeProvider.getBlastingRecipeName(Items.GOLD_NUGGET));
        ((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)((SimpleCookingRecipeBuilder)SimpleCookingRecipeBuilder.blasting(Ingredient.a(Items.IRON_PICKAXE, Items.IRON_SHOVEL, Items.IRON_AXE, Items.IRON_HOE, Items.IRON_SWORD, Items.IRON_HELMET, Items.IRON_CHESTPLATE, Items.IRON_LEGGINGS, Items.IRON_BOOTS, Items.IRON_HORSE_ARMOR, Items.CHAINMAIL_HELMET, Items.CHAINMAIL_CHESTPLATE, Items.CHAINMAIL_LEGGINGS, Items.CHAINMAIL_BOOTS), RecipeCategory.MISC, Items.IRON_NUGGET, 0.1f, 100).unlockedBy("has_iron_pickaxe", (Criterion)this.has(Items.IRON_PICKAXE))).unlockedBy("has_iron_shovel", (Criterion)this.has(Items.IRON_SHOVEL))).unlockedBy("has_iron_axe", (Criterion)this.has(Items.IRON_AXE))).unlockedBy("has_iron_hoe", (Criterion)this.has(Items.IRON_HOE))).unlockedBy("has_iron_sword", (Criterion)this.has(Items.IRON_SWORD))).unlockedBy("has_iron_helmet", (Criterion)this.has(Items.IRON_HELMET))).unlockedBy("has_iron_chestplate", (Criterion)this.has(Items.IRON_CHESTPLATE))).unlockedBy("has_iron_leggings", (Criterion)this.has(Items.IRON_LEGGINGS))).unlockedBy("has_iron_boots", (Criterion)this.has(Items.IRON_BOOTS))).unlockedBy("has_iron_horse_armor", (Criterion)this.has(Items.IRON_HORSE_ARMOR))).unlockedBy("has_chainmail_helmet", (Criterion)this.has(Items.CHAINMAIL_HELMET))).unlockedBy("has_chainmail_chestplate", (Criterion)this.has(Items.CHAINMAIL_CHESTPLATE))).unlockedBy("has_chainmail_leggings", (Criterion)this.has(Items.CHAINMAIL_LEGGINGS))).unlockedBy("has_chainmail_boots", (Criterion)this.has(Items.CHAINMAIL_BOOTS)).save(this.output, VanillaRecipeProvider.getBlastingRecipeName(Items.IRON_NUGGET));
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(Blocks.ANCIENT_DEBRIS), RecipeCategory.MISC, Items.NETHERITE_SCRAP, 2.0f, 100).unlockedBy("has_ancient_debris", (Criterion)this.has(Blocks.ANCIENT_DEBRIS)).save(this.output, VanillaRecipeProvider.getBlastingRecipeName(Items.NETHERITE_SCRAP));
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.STONE), RecipeCategory.BUILDING_BLOCKS, Blocks.CHISELED_STONE_BRICKS).unlockedBy("has_stone", (Criterion)this.has(Blocks.STONE)).save(this.output, "chiseled_stone_bricks_stone_from_stonecutting");
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.STONE), RecipeCategory.DECORATIONS, Blocks.STONE_BRICK_WALL).unlockedBy("has_stone", (Criterion)this.has(Blocks.STONE)).save(this.output, "stone_brick_walls_from_stone_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.QUARTZ_BLOCK), RecipeCategory.BUILDING_BLOCKS, Blocks.QUARTZ_SLAB, 2).unlockedBy("has_quartz_block", (Criterion)this.has(Blocks.QUARTZ_BLOCK)).save(this.output, "quartz_slab_from_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.STONE_BRICKS), RecipeCategory.DECORATIONS, Blocks.STONE_BRICK_WALL).unlockedBy("has_stone_bricks", (Criterion)this.has(Blocks.STONE_BRICKS)).save(this.output, "stone_brick_wall_from_stone_bricks_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.PRISMARINE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.PRISMARINE_BRICK_SLAB, 2).unlockedBy("has_prismarine_brick", (Criterion)this.has(Blocks.PRISMARINE_BRICKS)).save(this.output, "prismarine_brick_slab_from_prismarine_stonecutting");
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.PRISMARINE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.PRISMARINE_BRICK_STAIRS).unlockedBy("has_prismarine_brick", (Criterion)this.has(Blocks.PRISMARINE_BRICKS)).save(this.output, "prismarine_brick_stairs_from_prismarine_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.MOSSY_STONE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.MOSSY_STONE_BRICK_SLAB, 2).unlockedBy("has_mossy_stone_bricks", (Criterion)this.has(Blocks.MOSSY_STONE_BRICKS)).save(this.output, "mossy_stone_brick_slab_from_mossy_stone_brick_stonecutting");
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.MOSSY_STONE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.MOSSY_STONE_BRICK_STAIRS).unlockedBy("has_mossy_stone_bricks", (Criterion)this.has(Blocks.MOSSY_STONE_BRICKS)).save(this.output, "mossy_stone_brick_stairs_from_mossy_stone_brick_stonecutting");
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.MOSSY_STONE_BRICKS), RecipeCategory.DECORATIONS, Blocks.MOSSY_STONE_BRICK_WALL).unlockedBy("has_mossy_stone_bricks", (Criterion)this.has(Blocks.MOSSY_STONE_BRICKS)).save(this.output, "mossy_stone_brick_wall_from_mossy_stone_brick_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.END_STONE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.END_STONE_BRICK_SLAB, 2).unlockedBy("has_end_stone_brick", (Criterion)this.has(Blocks.END_STONE_BRICKS)).save(this.output, "end_stone_brick_slab_from_end_stone_brick_stonecutting");
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.END_STONE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.END_STONE_BRICK_STAIRS).unlockedBy("has_end_stone_brick", (Criterion)this.has(Blocks.END_STONE_BRICKS)).save(this.output, "end_stone_brick_stairs_from_end_stone_brick_stonecutting");
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.END_STONE_BRICKS), RecipeCategory.DECORATIONS, Blocks.END_STONE_BRICK_WALL).unlockedBy("has_end_stone_brick", (Criterion)this.has(Blocks.END_STONE_BRICKS)).save(this.output, "end_stone_brick_wall_from_end_stone_brick_stonecutting");
        ...
        VanillaRecipeProvider.smithingTrims().forEach($$0 -> this.trimSmithing($$0.template(), $$0.patternId(), $$0.recipeId()));
        ...
        this.copySmithingTemplate((ItemLike)Items.BOLT_ARMOR_TRIM_SMITHING_TEMPLATE, Ingredient.a(Items.COPPER_BLOCK, Items.WAXED_COPPER_BLOCK));
        ...
        this.doorBuilder(Blocks.COPPER_DOOR, Ingredient.of(Items.COPPER_INGOT)).unlockedBy(VanillaRecipeProvider.getHasName(Items.COPPER_INGOT), this.has(Items.COPPER_INGOT)).save(this.output);
        this.trapdoorBuilder(Blocks.COPPER_TRAPDOOR, Ingredient.of(Items.COPPER_INGOT)).unlockedBy(VanillaRecipeProvider.getHasName(Items.COPPER_INGOT), this.has(Items.COPPER_INGOT)).save(this.output);
    ...
    private void shulkerBoxRecipes() {
        ...
        for (DyeColor $$1 : DyeColor.values()) {
            TransmuteRecipeBuilder.transmute(RecipeCategory.DECORATIONS, $$0, Ingredient.of(DyeItem.byColor($$1)), ShulkerBoxBlock.getBlockByColor($$1).asItem()).group("shulker_box_dye").unlockedBy("has_shulker_box", (Criterion)this.has(ItemTags.SHULKER_BOXES)).save(this.output);
        }
    }
    ...
    private void bundleRecipes() {
        ...
        for (DyeColor $$1 : DyeColor.values()) {
            ...
            TransmuteRecipeBuilder.transmute(RecipeCategory.TOOLS, $$0, Ingredient.of($$2), BundleItem.getByColor($$1)).group("bundle_dye").unlockedBy(VanillaRecipeProvider.getHasName($$2), (Criterion)this.has($$2)).save(this.output);
        }
    }
