...
extends KeyTagProvider<Biome> {
    ...
    protected void addTags(HolderLookup.Provider $$02) {
        ...
        List $$1 = MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD.usedBiomes().toList();
        ...
        this.tag(BiomeTags.HAS_TRIAL_CHAMBERS).addAll($$1.stream().filter($$0 -> $$0 != Biomes.DEEP_DARK));
