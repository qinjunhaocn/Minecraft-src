...
extends KeyTagProvider<GameEvent> {
    ...
    protected void addTags(HolderLookup.Provider $$0) {
        ...
        this.tag(GameEventTags.IGNORE_VIBRATIONS_SNEAKING).a(GameEvent.HIT_GROUND.key(), GameEvent.PROJECTILE_SHOOT.key(), GameEvent.STEP.key(), GameEvent.SWIM.key(), GameEvent.ITEM_INTERACT_START.key(), GameEvent.ITEM_INTERACT_FINISH.key());
