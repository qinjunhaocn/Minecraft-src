...
public class PileFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> $$0) {
        ...
        FeatureUtils.register($$0, PILE_ICE, Feature.BLOCK_PILE, new BlockPileConfiguration(new WeightedStateProvider(WeightedList.builder().add(Blocks.BLUE_ICE.defaultBlockState(), 1).add(Blocks.PACKED_ICE.defaultBlockState(), 5))));
        FeatureUtils.register($$0, PILE_PUMPKIN, Feature.BLOCK_PILE, new BlockPileConfiguration(new WeightedStateProvider(WeightedList.builder().add(Blocks.PUMPKIN.defaultBlockState(), 19).add(Blocks.JACK_O_LANTERN.defaultBlockState(), 1))));
    }
}
