...
public class CommonLinks {
    ...
    public static String extendRealms(@Nullable String $$0, UUID $$1, boolean $$2) {
        ...
        return CommonLinks.extendRealms($$0, $$1) + "&ref=" + ($$2 ? "expiredTrial" : "expiredRealm");
    }
    ...
    public static String extendRealms(@Nullable String $$0, UUID $$1) {
        ...
        return "https://aka.ms/ExtendJavaRealms?subscriptionId=" + $$0 + "&profileId=" + UndashedUuid.toString((UUID)$$1);
    }
}
