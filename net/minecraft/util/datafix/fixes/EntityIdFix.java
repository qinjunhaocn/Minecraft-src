...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq((TypeRewriteRule)this.convertUnchecked("item stack entity name hook converter", $$2, $$3), (TypeRewriteRule)this.fixTypeEverywhere("EntityIdFix", (Type)$$02, (Type)$$1, $$0 -> $$02 -> $$02.mapFirst($$0 -> ID_MAP.getOrDefault($$0, (String)$$0))));
    }
}
