...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        OpticFinder $$42 = $$3.type().findField("Name");
        OpticFinder $$5 = DSL.typeFinder((Type)$$1);
        return this.fixTypeEverywhereTyped("ItemCustomNameToComponentFix", $$0, $$4 -> $$4.updateTyped($$2, $$3 -> $$3.updateTyped($$3, $$2 -> $$2.updateTyped($$42, $$1 -> $$1.update($$5, $$0 -> $$0.mapSecond(LegacyComponentDataFixUtils::createTextComponentJson))))));
    }
}
