...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix" + this.getOutputSchema().getVersionKey(), $$0, $$4 -> {
            ...
            if ($$5.isPresent() && Objects.equals(((Pair)$$5.get()).getSecond(), this.itemType) && ($$8 = ($$7 = ($$6 = $$4.getOrCreateTyped($$3)).getOrCreateTyped($$42)).getOptional($$2)).isPresent()) {
                return $$4.set($$1, (Object)Pair.of((Object)References.ITEM_NAME.typeName(), (Object)MAP.getOrDefault($$8.get(), "minecraft:pig_spawn_egg")));
            }
            return $$4;
        });
    }
