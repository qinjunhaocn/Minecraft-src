...
public class MemoryModuleType<U> {
    ...
    private static <U> MemoryModuleType<U> register(String $$0, Codec<U> $$1) {
        return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, ResourceLocation.withDefaultNamespace($$0), new MemoryModuleType<U>(Optional.of($$1)));
    }

    private static <U> MemoryModuleType<U> register(String $$0) {
        return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, ResourceLocation.withDefaultNamespace($$0), new MemoryModuleType<U>(Optional.empty()));
    }
}
