...
{
    public static final Codec<ChickenVariant> DIRECT_CODEC = RecordCodecBuilder.create($$0 -> $$0.group((App)ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(ChickenVariant::modelAndTexture), (App)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(ChickenVariant::spawnConditions)).apply((Applicative)$$0, ChickenVariant::new));
    public static final Codec<ChickenVariant> NETWORK_CODEC = RecordCodecBuilder.create($$0 -> $$0.group((App)ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(ChickenVariant::modelAndTexture)).apply((Applicative)$$0, ChickenVariant::new));
