...
{
    public static final Codec<CowVariant> DIRECT_CODEC = RecordCodecBuilder.create($$0 -> $$0.group((App)ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(CowVariant::modelAndTexture), (App)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(CowVariant::spawnConditions)).apply((Applicative)$$0, CowVariant::new));
    public static final Codec<CowVariant> NETWORK_CODEC = RecordCodecBuilder.create($$0 -> $$0.group((App)ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(CowVariant::modelAndTexture)).apply((Applicative)$$0, CowVariant::new));
    ...
    private CowVariant(ModelAndTexture<ModelType> $$0) {
    ...
    implements StringRepresentable {
        ...
        public static final /* enum */ ModelType WARM = new ModelType("warm");
