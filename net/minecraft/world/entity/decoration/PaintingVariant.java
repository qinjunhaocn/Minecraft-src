...
public record PaintingVariant(int width, int height, ResourceLocation assetId, Optional<Component> title, Optional<Component> author) {
    public static final Codec<PaintingVariant> DIRECT_CODEC = RecordCodecBuilder.create($$0 -> $$0.group((App)ExtraCodecs.intRange(1, 16).fieldOf("width").forGetter(PaintingVariant::width), (App)ExtraCodecs.intRange(1, 16).fieldOf("height").forGetter(PaintingVariant::height), (App)ResourceLocation.CODEC.fieldOf("asset_id").forGetter(PaintingVariant::assetId), (App)ComponentSerialization.CODEC.optionalFieldOf("title").forGetter(PaintingVariant::title), (App)ComponentSerialization.CODEC.optionalFieldOf("author").forGetter(PaintingVariant::author)).apply((Applicative)$$0, PaintingVariant::new));
