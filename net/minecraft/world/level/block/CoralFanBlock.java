...
extends BaseCoralFanBlock {
    public static final MapCodec<CoralFanBlock> CODEC = RecordCodecBuilder.mapCodec($$02 -> $$02.group((App)CoralBlock.DEAD_CORAL_FIELD.forGetter($$0 -> $$0.deadBlock), CoralFanBlock.propertiesCodec()).apply((Applicative)$$02, CoralFanBlock::new));
