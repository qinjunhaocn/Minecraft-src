...
public class BlockStateProperties {
    ...
    public static final EnumProperty<Direction.Axis> HORIZONTAL_AXIS = EnumProperty.a((String)"axis", Direction.Axis.class, (Enum[])new Direction.Axis[]{Direction.Axis.X, Direction.Axis.Z});
    ...
    public static final EnumProperty<Direction> FACING = EnumProperty.a((String)"facing", Direction.class, (Enum[])new Direction[]{Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST, Direction.UP, Direction.DOWN});
    public static final EnumProperty<Direction> FACING_HOPPER = EnumProperty.create("facing", Direction.class, $$0 -> $$0 != Direction.UP);
    ...
    public static final EnumProperty<RailShape> RAIL_SHAPE_STRAIGHT = EnumProperty.create("shape", RailShape.class, $$0 -> $$0 != RailShape.NORTH_EAST && $$0 != RailShape.NORTH_WEST && $$0 != RailShape.SOUTH_EAST && $$0 != RailShape.SOUTH_WEST);
    ...
    public static final EnumProperty<Direction> VERTICAL_DIRECTION = EnumProperty.a((String)"vertical_direction", Direction.class, (Enum[])new Direction[]{Direction.UP, Direction.DOWN});
