...
public class Noises {
    ...
    public static NormalNoise instantiate(HolderGetter<NormalNoise.NoiseParameters> $$0, PositionalRandomFactory $$1, ResourceKey<NormalNoise.NoiseParameters> $$2) {
        Holder.Reference<NormalNoise.NoiseParameters> $$3 = $$0.getOrThrow($$2);
        return NormalNoise.create($$1.fromHashOf(((ResourceKey)$$3.unwrapKey().orElseThrow()).location()), (NormalNoise.NoiseParameters)((Object)$$3.value()));
    }
}
